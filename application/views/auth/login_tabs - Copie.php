    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-header">
                <h2><i class="fas fa-graduation-cap me-2"></i>Espace Numérique Personnel</h2>
                <p class="mb-0 mt-2">Authentification</p>
            </div>
        ...
        document.getElementById('loginAdminForm').addEventListener('submit', function(e) {
            ...
            .then(data => {
                if (data.success) {
                    showMessage(data.message, 'success', messageDiv);
                    setTimeout(() => {
                        window.location.href = data.redirect || BASE_URL + 'dashboard_admin';
                    }, 1000);
                } else {
                    showMessage(data.message, 'error', messageDiv);
                }
