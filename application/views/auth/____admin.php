...
<head>
    ...
    <title>Connexion Admin - Espace Administrateur</title>
                    ...
                    <div class="card-body px-5 py-5">
                        ...
                        <form id="admin-login-form" method="post">
                            <div class="form-group">
                                <label>Login *</label>
                                <input type="text" id="login" name="login" class="form-control p_input" maxlength="50" placeholder="Votre login" required>
                            </div>
                            <div class="form-group">
                                <label>Mot de passe *</label>
                                <input type="password" id="motdepasse" name="motdepasse" class="form-control p_input" maxlength="50" placeholder="Mot de passe" required>
                            </div>
                            ...
                            <div class="text-center mt-2">
                                <a href="<?= base_url('auth') ?>" class="btn btn-outline-secondary btn-sm">Retour Étudiant</a>
                            </div>
                        </form>
                    </div>
                </div>
...
document.getElementById('admin-login-form').addEventListener('submit', function(e){
    ...
    .then(data => {
        ...
        if(data.success){
            ...
            setTimeout(() => { window.location.href = BASE_URL + 'admin/dashboard'; }, 800);
        } else {
