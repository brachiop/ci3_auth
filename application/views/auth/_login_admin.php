...
<head>
    ...
    <style>
        ...
        .student-login { text-align: center; margin-top: 15px; }
        .student-login a { color: #fff; text-decoration: underline; }
    </style>
</head>
<body>
                    ...
                    <div class="card-body px-5 py-5">
                        ...
                        <form id="admin-login-form" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" id="login" name="login" class="form-control p_input" maxlength="50" placeholder="Nom d'utilisateur ou Email" required>

                            </div>
                            <div class="form-group">
                                <label>Mot de passe *</label>
                                <input type="password" id="motdepasse" name="motdepasse" class="form-control p_input" placeholder="Mot de passe" required>
                            </div>
                            ...
                            <!-- Lien retour étudiant -->
                            <div class="student-login">
                                <a href="<?= site_url('auth') ?>">Connexion Étudiant</a>
                            </div>
                        </form>
                    </div>
                </div>
...
<script src="<?= base_url('assets/js/login_admin.js') ?>"></script>
</body>
</html>
