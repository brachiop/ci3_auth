                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="alert alert-info">
                            ...
                            <ul class="mb-0">
                                <li>Préparez un fichier CSV avec les colonnes : <code>CODE_FIL, LIBEL_FIL, TYPE, SEM_DEPART, NB_PARC, DISCIPLINE</code></li>
                        ...
                        <form method="post" enctype="multipart/form-data" action="<?php echo site_url('import/filieres'); ?>">
                            ...
                            <div class="mt-4">
                                ...
                                <a href="<?php echo site_url('import/download_template_filieres'); ?>" class="btn btn-outline-warning float-right">
