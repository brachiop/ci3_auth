            ...
            <div class="row mb-4">
                <div class="col-md-3 mb-3">
                    <div class="card bg-primary text-white">
                        <div class="card-body text-center p-3">
                            <h5 class="mb-1"><?= $stats['total_utilisateurs'] ?></h5>
                            <p class="mb-0 small">Utilisateurs total</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mb-3">
                    <div class="card bg-success text-white">
                        <div class="card-body text-center p-3">
                            <h5 class="mb-1"><?= $stats['utilisateurs_actifs'] ?></h5>
                ...
                <div class="col-md-3 mb-3">
                    <div class="card bg-info text-white">
                        <div class="card-body text-center p-3">
                            <h5 class="mb-1"><?= $stats['super_admins'] ?></h5>
                            <p class="mb-0 small">Super Admins</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mb-3">
                    <div class="card bg-warning text-white">
                        <div class="card-body text-center p-3">
                            <h5 class="mb-1"><?= $stats['guichets'] ?></h5>
                            <p class="mb-0 small">Guichets</p>
                        </div>
                    </div>
                </div>
            </div>
